  ...
  return (
    <Layout title="Ask a Question" currentUser={props.currentUser}>
      ...
      <div className="login-container">
        {/* Header with logo (optional, can be removed or modified) */}
        ...
        <div className="login-form-wrapper">
          {/* Changed class from login-card to question-card */}
          <div className="card question-card shadow-lg animate-fade-in">
